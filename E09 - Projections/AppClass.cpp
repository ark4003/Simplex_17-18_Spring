...
void Application::Display(void)
{
	...
	case 2:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 20.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(1.0f, 0.0f, 0.0f));
		break;
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(-20.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(20.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
	...
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 0.0f, -40.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, 30.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 1.0f));
		break;
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0.0f, -30.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 1.0f));
